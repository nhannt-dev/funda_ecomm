                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="small_description" id="small_description" rows="4"></textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="tab-pane fade border p-3" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_keyword" id="meta_keyword" rows="4" class="form-control"></textarea>
                                </div>
                                <div class="mb-3">
